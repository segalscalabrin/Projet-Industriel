...
int main(int ac, char **av)
{
  ...
  /*----------------- Boundary conditions ------------------*/
  // Gauche vitesse fixé haut bas vitesse nulle droite pression nulle
  ...
  // Condition au bord leveset Neumann homogene 
